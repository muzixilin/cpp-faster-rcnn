...
namespace caffe {
	...
	*/
	...
	protected:
		...
		void SaveBlob2txt(char* szSaveFileName, Blob<Dtype>& blob);
		void SaveBlob2txt2(char* szSaveFileName, Blob<Dtype>& boxes, Blob<Dtype>& scores);
		void RestoreBlobFromtxt(char* szSaveFileName, Blob<Dtype>& boxes, Blob<Dtype>& scores);
